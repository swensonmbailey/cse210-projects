...
class Program
{
    static void Main(string[] args)
    {
        ...
        video1.title = "Reading the King Follet Discourse in Context";
        video1.author = "Read It BoM";
        ...
        video2.title = "Oliver Cowdery's testimony during his excommunication: irrefutable";
        video2.author = "Read It BoM";
        ...
        video3.title = "The Hypostatic Union";
        video3.author = "Read It BoM";
